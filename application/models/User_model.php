...
class User_model extends CI_Model
{
    ...
    function userListingCount($searchText = '')
    {
        ...
        $this->db->join('sys_roles as Role', 'Role.roleId = BaseTbl.roleId','left');
        if(!empty($searchText)) {
    ...
    {
        $this->db->trans_start();
        $this->db->insert('sys_users', $userInfo);
    ...
    {
        $this->db->where('userId', $userId);
        $this->db->update('sys_users', $userInfo);
    ...
    function loginHistoryCount($userId, $searchText, $fromDate, $toDate)
    {
        ...
        $this->db->from('sys_last_login as BaseTbl');
        $query = $this->db->get();
