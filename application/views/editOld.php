              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Masukan Detail User</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" placeholder="Nama Lengkap" name="fname" value="<?php echo $name; ?>" maxlength="128">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" placeholder="Alamat email" name="email" value="<?php echo $email; ?>" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cpassword">Confirmasi Password</label>
