        <br>
        <div class="footer-copyright-area" style="width: 100%; height: 10px; position: fixed; bottom: 0;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-copy-right" style="margin-top: 0px; ">
                            <div class="row">
                                <div class="col-md-5">
                                    <p style="color: #000; font-size: 13px;">Copyright © 2021. All rights reserved. Powered by <b>GIT Software Developer</b></p>
                                </div>
                                <div class="col-md-5">
                                    <p style="color: #000; font-size: 13px; text-align: right;">Version 2.0.0</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#txtIntegritas').summernote({
                placeholder: "Isi Konten Informasi Zona Integritas . . .",
                height: '260'
            });
            $('#txtProfil').summernote({
                placeholder: "Isi Konten Profil . . .",
                height: '240'
            });
            $('#txtKontenStandar').summernote({
                placeholder: "Isi Konten Profil . . .",
                height: '240'
            });
            $('#ckck').summernote({
                placeholder: "Isi Konten Standar Pelayanan . . .",
                height: '200'
            });
            $('#ckck2').summernote({
                placeholder: "Isi Konten Standar Pelayanan . . .",
