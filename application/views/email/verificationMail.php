...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Proses Pengajuan Selesai</title>
	</head>
	<body>
		<div>
												...
												<tr>
													<td style="padding:17px 3.358% 15px">
														<cite style="text-align:center;display:block;font-style:normal">
															<span style="font-size:1px;min-height:0;color:#fff;width:0;display:block">Pemberitahuan Layanan KPPN Sujunjung.</span>
															...
															<table cellpadding="0" cellspacing="0" style="width:100%;margin:0;padding:0">
																<tbody>
																	<tr>
																		<td align="center">
																			<div style="width:100%">
																				<b>Hi, <?php echo $data["satker"]; ?></b>! <br> <?php echo $data["open_message"]; ?> <b><?php echo $data["surat"]; ?></b> <span class="il"><?php echo $data["message"]; ?></span>
