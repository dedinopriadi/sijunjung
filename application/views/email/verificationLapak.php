...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Verifikasi Aktivasi Lapak</title>
	</head>
	<body>
		<div>
															...
															<table cellpadding="0" cellspacing="0" style="width:100%;margin:0;padding:0">
																<tbody>
																	<tr>
																		<td align="center">
																			<div style="width:100%">
																				<b>Hi, <?php echo $data["name"]; ?></b>! <br> <?php echo $data["open_message"]; ?> <b><?php echo $data["lapak_name"]; ?></b> <span class="il"><?php echo $data["message"]; ?></span>
