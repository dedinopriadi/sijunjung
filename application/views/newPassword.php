...
<html>
  <head>
    <meta charset="UTF-8">
    <title>IGT | Reset Password</title>
    <link href="<?php echo base_url(); ?>assets/softland/assets/img/ic_interlink.png" rel="icon">
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>IGT Home Page</b><br>Admin System</a>
      </div><!-- /.login-logo -->
