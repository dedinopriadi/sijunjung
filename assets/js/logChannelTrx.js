...
app.controller('logchanneltrxCtrl',function($scope, $rootScope, $http){
  var vm = this;
  ...
  $scope.filter = {};
    ...
    $scope.getLogChannelTrx = function(pageno) {
       $scope.dataLoadedSuccessfully = false;
       $scope.loaded = false;
      $http({
        method: 'POST',
        url: baseURL + "logChannelTrxListing",
